...
bot = TeleBot(token='5712215295:AAGj6TDiGRXhbIns5sbM4UnSGLGcXtoxwcI', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Hi! I help you check the correctness of your JSON code, just send it to me 😘\nAuthor: QA Denis Pichugin.\nВведи JSON в виде строки:', # текст сообщения
    )
